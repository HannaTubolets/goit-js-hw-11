//? Variant 3
// export class PixabayImgAPI {
//     static BASE_URL = 'https://pixabay.com/api/';
//     static API_KEY = '32846684-9759f804fcaf49bb92c6f21b5';
...
//     fetchImages = async (inputValue, pageNr) => {
...
//         per_page: '40',
//         page: pageNr,
//         key: PixabayImgAPI.API_KEY,
//     });
//     return await fetch(`${PixabayImgAPI.BASE_URL}?${searchParams}`) 
//         .then(async response => {
//             if (!response.ok) {
